...
| 服务 | 地址 | 说明 |
|------|------|------|
| **统一门户** | http://127.0.0.1:8080/ | 系统入口 |
| **任务管理** | http://127.0.0.1:8080/tasks/ | Plane 项目看板 |
| **代码托管** | http://127.0.0.1:8080/code/ | Gitea Git 服务 |
| **试验数据** | http://127.0.0.1:8080/data/ | Nextcloud 网盘 |
| **SSO 认证** | http://127.0.0.1:8080/auth/ | Keycloak 登录 |
| **MinIO 控制台** | http://127.0.0.1:9001/ | 对象存储管理 |
| **搜索 API** | http://127.0.0.1:7700/ | Meilisearch |
...
**管理控制台**: http://127.0.0.1:8080/auth/admin/
...
**访问地址**: http://127.0.0.1:8080/tasks/
...
**访问地址**: http://127.0.0.1:8080/code/

**SSH 地址**: `ssh://git@127.0.0.1:2222/用户名/仓库.git`
...
```bash
# HTTPS 克隆
git clone http://127.0.0.1:8080/code/用户名/仓库.git

# SSH 克隆
git clone ssh://git@127.0.0.1:2222/用户名/仓库.git
```
...
```bash
# mc 配置
mc alias set local http://127.0.0.1:9000 admin Km2024!Minio@Secure
